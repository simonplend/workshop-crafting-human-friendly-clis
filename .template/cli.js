...
try {
  ...
  throw new Error("Follow Exercise 01: Parsing arguments (exercises/01-parsing-arguments.md)");
  ...
  throw new Error("Follow Exercise 02: Interactive input (exercises/02-interactive-input.md)");
